...
class View:
    ...
    def __init__(self, language_names, instructions):
        ...
        self.status_label = tkinter.Entry(root, bg="#eeffee", fg='black')
        self.status_label.insert(0, instructions)
    ...
    def _init_controls(self, root):
        ...
        from_to_label = tkinter.Label(frame, text="From / to :", bg=bg_color)
        ...
        self.add_source_check_button = tkinter.Checkbutton(frame, text="Add source", bg=bg_color,
                                                           variable=self.is_add_src)
        self.is_add_transliteration = tkinter.IntVar()
        self.add_transliteration_check_button = tkinter.Checkbutton(frame, text="Transliterate", bg=bg_color,
        ...
        saved_label = tkinter.Label(frame, text="     Saved translations:", bg=bg_color)
        ...
        self.persistence_status_label = tkinter.Label(frame, width=10)
    ...
    def bind_controls(self, controller):
