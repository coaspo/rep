...
function oneFileTest() {
   ...
   expected = URL + 'tests/search-files/recipe.html">tests/search-files/recipe.html</a>: <b><id style=\'color:red\'>pizza</id></b>' 
...
function multipleFileTest() {
   ...
   expected = URL + 'tests/search-files/recipe.html">tests/search-files/recipe.html</a>: 3 <id style=\'color:red\'>cup</id>s flour\n'+
              '1 <id style=\'color:red\'>cup</id> water\n'+
              '\n'+
              URL + 'tests/search-files/problems-solutions.html">tests/search-files/problems-solutions.html</a>: oz in 1 <id style=\'color:red\'>cup</id>\n'+
...
function urlTest() {
   ...
   expectedHtml = URL + 'tests/search-files/recipe.html">tests/search-files/<id style=\'color:red\'>recipe</id>.html</a>'
   expectedUrl = URL + 'tests/search-files/recipe.html'
   ...
   expectedHtml = URL + 'tests/search-files/problems-solutions.html">tests/search-files/<id style=\'color:red\'>problem</id>s-solutions.html</a>\n'+
                  '\n'+
                  URL + 'tests/search-files/problems-solutions.html">tests/search-files/problems-solutions.html</a>: oz in 1 cup\n'+
...
function urlsTest() {
   ...
   expectedHtml = URL + 'tests/search-files/problems-solutions.html">tests/search-files/problems-<id style=\'color:red\'>solution</id>s.html</a>\n'+
                  URL + 'tests/search-files/misc-solutions.html">tests/search-files/misc-<id style=\'color:red\'>solution</id>s.html</a>'
